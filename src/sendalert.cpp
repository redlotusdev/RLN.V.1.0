...
2. run lotusd with -printalert or -sendalert like this:
   /path/to/lotusd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://lotuscoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Lotus Core:0.12.0.58/"));
