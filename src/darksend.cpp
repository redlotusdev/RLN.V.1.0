...
{
    if(fLiteMode) return; // ignore all Lotus related functionality
...
/*
    ...
    allow endless transaction that would bloat Lotus and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("lotus-privatesend");
