    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Lotus Core");
    ...
    QString copyrightTextLotus   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Lotus Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextLotus);
