    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Lotus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lotus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lotus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Lotus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lotus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lotus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lotus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lotus addresses"));
    ...
    openAction->setStatusTip(tr("Open a lotus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lotus Core help message to get a list with possible Lotus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Lotus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lotus network", "", count));
}
...
{
    QString strTitle = tr("Lotus Core"); // default title
