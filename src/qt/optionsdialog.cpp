    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LOTUS-light"), QVariant("light"));
    ui->theme->addItem(QString("LOTUS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LOTUS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LOTUS-traditional"), QVariant("trad"));
