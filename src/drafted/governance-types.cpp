...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LotusNetwork") type = LotusNetwork;
    if(strType == "LotusNetworkVariable") type = LotusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LotusNetwork) s = "LotusNetwork";
    if(type == LotusNetworkVariable) s = "LotusNetworkVariable";
