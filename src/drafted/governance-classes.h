 ...
 *
 *   // network
 *   CLotusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.lotuscoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLotusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LotusNetwork
// //   -- signature requirements : Key1(User)
// class CLotusNetworkVariable : public CGovernanceObject
// {
// private:
