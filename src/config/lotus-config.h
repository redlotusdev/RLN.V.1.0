/* src/config/lotus-config.h.  Generated from lotus-config.h.in by configure.  */
/* src/config/lotus-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Lotus Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Lotus Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/Lotus/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lotus Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lotus Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lotuscore"
