...
Only requiring some minor changes is lotus.cpp.
...
Changes to lotus.cpp
----------------------
lotus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
