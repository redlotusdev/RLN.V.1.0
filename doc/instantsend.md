...
This mechanism has been integrated into Bitcore-Node-Lotus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lotuscoin/insight-api-lotus#web-socket-api](https://github.com/lotuscoin/insight-api-lotus#web-socket-api) 
* API: [https://github.com/lotuscoin/insight-api-lotus#instantsend-transactions](https://github.com/lotuscoin/insight-api-lotus#instantsend-transactions) 
...
By default, the Lotus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Lotus Core daemon:
